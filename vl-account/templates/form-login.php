<?php
/**
 * Форма входа: по коду из SMS и (опционально) по паролю.
 *
 * @package VL_Account
 *
...
<form class="vl-form vl-form--login" data-vl-form="login" method="post" novalidate>
	...
	<div class="vl-step is-active" data-vl-step="phone">
		...
		<button type="button" class="vl-btn vl-btn--primary vl-btn--block" data-vl-action="send-code" data-purpose="login">
	...
	<?php else : ?>
		<p class="vl-links vl-links--footer">
			<button type="button" class="vl-link vl-link--muted" data-vl-action="show-lost"><?php esc_html_e( 'Не приходит код? Восстановить доступ', 'vl-account' ); ?></button>
		</p>
	<?php endif; ?>
